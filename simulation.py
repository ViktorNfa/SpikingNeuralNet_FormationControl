...
x, u, cbf_oa, nom_controller = fc.execute_snnfc_simulation(number_robots, dim, max_time_size, x_max, freq, L_G, L_G2, x_d1, x_d2, oa, d_oa, edges_fc, alpha, network, snn_agent)
